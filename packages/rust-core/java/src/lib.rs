...
fn make_operator_info<'a>(env: &mut JNIEnv<'a>, info: OperatorInfo) -> Result<JObject<'a>> {
  ...
  let result = env
        .new_object(
            "com/pleisto/OperatorInfo",
            "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lcom/pleisto/Capability;Lcom/pleisto/Capability;)V",
            &[
